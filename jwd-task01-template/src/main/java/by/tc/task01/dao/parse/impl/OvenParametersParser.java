 ...
 */
public class OvenParametersParser implements ParserCommand {
    @Override
    public List<String> execute(String line) {
        ...
        parameters.add(ParameterValueFounder.findValue(line, "CAPACITY"));
        parameters.add(ParameterValueFounder.findValue(line, "DEPTH"));
